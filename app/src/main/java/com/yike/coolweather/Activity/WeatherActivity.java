...
import com.yike.coolweather.Gson.Forecast;
...
public class WeatherActivity extends Activity {
    ...
    public void requestWeather(String weatherId){
        System.out.println("show: "+weatherId);
        //String weatherUrl = "http://guolin.tech/api/weather?cityid="+weatherId+"&key=bc0418b57b2d4918819d3974ac1285d9";
        //https://free-api.heweather.com/v5/weather?city=CN101280803&key=873e4f3389f44e72863d219a7a6fb06d
        String weatherUrl = "https://free-api.heweather.com/v5/weather?city="+weatherId+"&key=873e4f3389f44e72863d219a7a6fb06d";
    ...
    public void showWeatherInfo(Weather weather){
        ...
        for(Forecast forecast: weather.forecastList ){
            //Log.w(TAG, "showWeatherInfo: "+forecast.date+", "+forecast.more.info);
